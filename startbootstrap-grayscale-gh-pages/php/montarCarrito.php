...
while($res=$select->fetch_assoc()) {
    ...
    <tr class="producto" data-id="<?php echo $res['id']; ?>" data-precio="<?php echo $res['precio']; ?>">
        <td class="col-sm-8 col-md-6">
            <div class="media">
                <a class="thumbnail pull-left" href="../productos.html?<?php echo $res['id']; ?>"> <img class="media-object" src="../img/imgProduct/<?php echo $res['id']; ?>.jpg" alt="icono producto"> </a>
        ...
        <td class="col-sm-1 col-md-1 text-center">
            <input type="number" class="form-control cantidad_producto" value="<?php echo $oCantidades[$res['id']]; ?>" min="1"/>
        </td>
